...
public class ScriptPluginPluginLoader {
    ...
    public ScriptPlugin load(String scriptUriString,
        ...
        ClassLoaderScope scriptPluginScope = buildSrcScope.createChild("script-plugin-" + scriptUriString);

        ScriptSource scriptSource = new UriScriptSource(scriptDisplayName, toURI(scriptUriString));
